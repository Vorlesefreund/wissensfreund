...
- **~~Generator-Prompt-Konsolidierung / A-B (v3.24 vs v4)~~ → ERLEDIGT (22.06.):** v4 als Produktion übernommen, S1-Untergrenze 75→88 (Kap. 9). Daraus neu offen:
  ...
  - **BKS-Über-Verwerfung (offen):** Der BKS-Plausibilitäts-Guard verwirft teils zu viel — nicht nur „Knappe"/„Rüstung" (Ritter), jetzt auch bei Cheops-Pyramide „Sonnenbarke des Cheops"/„Kufu-Schiff" (selbe Familie). Folge: dünneres Grounding/teils nur 2 Companions. Bessere BKS-Auflösung/Alternativ-Kandidaten erwägen, damit zentrale belegbare Begriffe erhalten bleiben.
