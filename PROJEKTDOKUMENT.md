...
- **(01.07.) Validierungslauf für die drei Register-/Drastik-Regeln (0c045c6):** neuer Vulkan/Wal/WWII-Lauf, prüfen ob S1 nüchterner wird (keine "sanfte Riesen"/"schlaue Töne"), ob der Generator intensivierende Verstärker ("viel größer") von selbst vermeidet, und ob S3 keine drastischen Methodendetails mehr ausmalt. Gemeinsam mit dem ohnehin offenen c-Nachlauf möglich.
