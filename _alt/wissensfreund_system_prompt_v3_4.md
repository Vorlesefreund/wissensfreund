...
Wenn ein `stimmt`-Callout in einem eigenen Abschnitt steht:
- Der Abschnittstitel darf NICHT „Stimmt das?" lauten — das ist doppelt zum Box-Label
- Der Abschnitt braucht mindestens 2–3 echte Inhaltssätze vor der Box
- Diese Sätze liefern Kontext oder leiten das Klischee ein — kein Füllsatz wie
  „Es gibt viele Missverständnisse darüber"
- Besser: Abschnitt unter thematischem Titel (z.B. „Ein weit verbreiteter Irrtum",
...
- [ ] Hat jedes Bild alt, source_url, author, license aus IMAGE_METADATA?
- [ ] Ist index 0 das treffendste Hauptbild?
- [ ] Hat jeder Satz einen sinnvollen img_index?
