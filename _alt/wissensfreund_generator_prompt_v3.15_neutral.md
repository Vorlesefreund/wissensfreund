# WISSENSFREUND — Universeller Artikel-Generator (v3.15, Testfassung Markdown)
...
- Hochrisiko (Superlative, „sogar", „einzige", „immer/nie/alle", konkrete Zahlen, klinische Begriffe)
...
**S1: nur wow + warnung.** Max. 1 Box/Abschnitt. Keine Box im intro. Max. 1 stimmt_das (S2), max. 2 (S3).
Box bringt immer Neues — nie dieselbe Aussage wie im Absatz. Anzeige-Label = nur Emoji (kein „wow"/„fakt"-Text).
**Boxen über den Text verteilen** — sie sollen einzelne Abschnitte auflockern. NICHT mehrere Boxen am Stück
...
**stimmt_das:** Klischee aus Volksmund/Film/Schulwissen. Thema im Fließtext, AUFLÖSUNG nur in der Box.
Denselben Fakt nicht als Haken UND als stimmt_das verwenden. **Es muss ein ECHTER verbreiteter Irrglaube sein
(etwas, das viele Kinder/Leute tatsächlich glauben) — NICHT eine gerade im Text erklärte Regel in Frageform
und nicht eine Trivialität.** Schwaches Beispiel (vermeiden): „Darf man nach dem Dribbeln nochmal dribbeln?",
wenn das Doppeldribbling gerade erklärt wurde. Starkes Beispiel: ein echtes Missverständnis über das Thema.
...
Superlative/Vergleiche mit dem Geltungsbereich der Quelle?
...
Boxen: jede eigenständig + bringt Neues; warnung nur für Heikles; wow nur bei echtem Staunen; Label nur Emoji;
