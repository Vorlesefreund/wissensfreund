#!/usr/bin/env python3
"""
Pilot-Generierung 3: 4 Themen × 3 Stufen — Verifikation WORTZIEL-Refinement (harter Deckel).
Geänderte Variable vs. Lauf 2: Obergrenze wieder explizit als harter Stopp + Auswahlregel.
Ausgabe: pilot_output3/<Thema>_S<N>.md + pilot_wortzahlen3.csv
"""
...
# ── 4 Verifikations-Themen (gleiche Ziele wie Lauf 2) ────────────────────────
# Dinosaurier = Regressions-Kontrolle, Hund = Undershoot,
# Vulkan + Kühlschrank = Overshoot
PILOT_TARGETS = {
...
# Identische Konfiguration wie Lauf 2
try:
...
def make_user_msg(job, primary_text, companion_texts, companion_order, wmax):
    """Stabiler Prefix + WORTZIEL-Wording aus generate_grounded.py (Lauf 3)."""
