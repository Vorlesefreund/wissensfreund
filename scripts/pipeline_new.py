...
def _level_register(stufe: int) -> str:
    return {
        1: "Stufe 1 (ca. 4–6 Jahre, wird meist vorgelesen): kurze, einfache Sätze "
           ...
           "direkt ansprechen oder eine kleine Frage stellen — variiere den Einstieg "
           "und vermeide die abgenutzte Formel 'Stell dir vor …'. Beschreibe konkret "
...
PASS2_SYSTEM = (
    ...
    "Fakten beruhen und keinen neuen Fakt erfinden). Verwende "
