...
LEKTORAT_A_SYSTEM = (
    ...
    "unangetastet. Für jede Meldung gib den minimal korrigierten Satz (quellenbasiert, "
...
LEKTORAT_B_SYSTEM = (
    ...
    "Fakten. Minimaler Eingriff — ändere nur Sätze, die sprachlich wirklich besser "
    "werden. PFLICHT: Für JEDEN geänderten Satz gib ein WÖRTLICHES Quellzitat (beleg), "
