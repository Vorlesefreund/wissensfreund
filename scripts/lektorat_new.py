...
LEKTORAT_A_SYSTEM = (
    ...
    "Grammatik. Melde nur drei Fälle:\n"
    ...
    "3. Falsche Verknüpfung/Einordnung: Der Satz verbindet zwei einzeln korrekte "
    "Fakten zu einer Aussage, die die Quelle SO nicht hergibt — besonders "
    "klassifizierende oder Beispiel-Aussagen („X ist ein solcher/ein Beispiel für "
    "Y“). Prüfe, ob die Quelle die BEZIEHUNG selbst deckt (dass X wirklich zu Y "
    "gehört), nicht nur die Einzelteile. Deckt sie die Beziehung nicht → melden.\n"
...
LEKTORAT_B_SYSTEM = (
    ...
    "kindgerechte Klarheit. Achte auch auf idiomatisch korrekte KOLLOKATIONEN — "
    "falsche Wortpaarungen sind ein Sprachfehler und dürfen korrigiert werden (kein "
    "neuer Fakt): z. B. Tonhöhe „tiefe/hohe Töne“, NICHT „niedrige/hohe Töne“; "
    "„starker Regen“, nicht „großer Regen“. "
    "Führe KEINE neuen Fakten ein und entferne keine belegten "
