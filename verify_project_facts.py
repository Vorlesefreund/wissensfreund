...
CHECKS = [
  ...
  {"desc":"Vision/Bild-Auswahl-Modell = Claude Sonnet-5 (config-getrieben, stage_models)","sev":"FAIL","type":"contains",
   "file":"scripts/stage_models.py","needle":'"vision":         {"provider": "anthropic", "model": "claude-sonnet-5"'},
  ...
  {"desc":"Hörspiel-Prompt verdrahtet (content_type-Auswahl, Paket B)","sev":"FAIL","type":"contains",
   "file":"scripts/generate_grounded.py","needle":"wissensfreund_hoerspiel_prompt_v2.md"},
  {"desc":"Hörspiel-Prompt-Datei existiert (v2 Story-first)","sev":"FAIL","type":"file_exists",
   "file":"wissensfreund_hoerspiel_prompt_v2.md"},
  ...
  {"desc":"Stufen-Umbau: Hörspiel-Band = (225,975) wie altes S3 (PO 2026-07-18)","sev":"FAIL","type":"contains",
   "file":"scripts/generate_grounded.py","needle":'"hoerspiel":   (225, 975)'},
